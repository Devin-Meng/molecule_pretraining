...
from method.model.layers import EncoderLayer
from method.utils.lr import PolynomialDecayLR
    ...
    def forward(self, batched_data, perturb=None):
        ...
        if self.edge_type == 'multi_hop':
            ...
            edge_input = edge_input_flat.reshape(
                max_dist, num_graph, num_node, num_node, self.num_heads).permute(1, 2, 3, 0, 4)
